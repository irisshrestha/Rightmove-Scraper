...
url = "https://www.rightmove.co.uk/property-for-sale/find.html?searchType=SALE&locationIdentifier=REGION%5E1460&insId=1&radius=0.0&minPrice=&maxPrice=&minBedrooms=&maxBedrooms=&displayPropertyType=&maxDaysSinceAdded=&_includeSSTC=on&sortByPriceDescending=&primaryDisplayPropertyType=&secondaryDisplayPropertyType=&oldDisplayPropertyType=&oldPrimaryDisplayPropertyType=&newHome=&auction=false"
...
property = soup.find("div", class_="propertyCard-wrapper")
...
with open("property.csv", "w", newline="") as file:
    ...
    field = ["Price", "Type", "Shared ownership", "Bedrooms", "Bathrooms", "Description", "Link"]
    writer.writerow(field)
    writer.writerow([price, property_type, shared_owner, no_bedrooms, no_bathrooms, property_description, link])
"""
#TO DO
#Go to main page and extract more information
#Tidy up code - neater way of organising variables
#Tidy up CSV writing
#Ask for a set number of properties
#Ask if they would like text or csv output
